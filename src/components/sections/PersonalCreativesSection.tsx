...
const PersonalCreativesSection = () => {
  ...
  const contentByTab: Record<TabKey, Item[]> = {
    photos: [
      ...
      { title: 'Camp 06', description: 'Camping moments 06', src: `${process.env.NODE_ENV === 'production' ? '/portfolio' : ''}/images/camp/camp_6.webp`, width: 1740, height: 1160, category: 'Camp', location: 'Aslanlar Göleti', date: '—' },
      { title: 'Camp 07', description: 'Camping moments 07', src: `${process.env.NODE_ENV === 'production' ? '/portfolio' : ''}/images/camp/camp_7.webp`, width: 1740, height: 1160, category: 'Camp', location: 'Aslanlar Göleti', date: '—' },
      { title: 'Camp 08', description: 'Camping moments 08', src: `${process.env.NODE_ENV === 'production' ? '/portfolio' : ''}/images/camp/camp_8.webp`, width: 1740, height: 1160, category: 'Camp', location: 'Aslanlar Göleti', date: '—' },
      // Anatolia kategorisi
